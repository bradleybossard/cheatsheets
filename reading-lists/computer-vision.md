...
[Sparse YOLOv5: 10x faster and 12x smaller - Neural Magic](https://neuralmagic.com/blog/benchmark-yolov5-on-cpus-with-deepsparse/)

[Overview — DeepSparse 0.7.0 documentation](https://docs.neuralmagic.com/deepsparse/)
