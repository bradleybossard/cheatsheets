[Open Reference Architecture for Security and Privacy — Open Reference Architecture for Security and Privacy 2019-Q4 documentation](https://security-and-privacy-reference-architecture.readthedocs.io/en/latest/)
